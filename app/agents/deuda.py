...
_DEUDAS = (
    dict(id="D-001", gravedad=FALSEA, capa="C1/C3", dueño="Javo",
         ...
         medicion_008="GM-Ω-ICPI-008 (2026-09-03) la midió y encontró TRES "
                      ...
                      "**(2) EL CRITERIO DE SELECCIÓN NO EXISTE EN NINGÚN "
                      "DOCUMENTO**: se sabe que las 25 son legítimas, no POR QUÉ "
                      "esas 25, y de eso depende si la muestra es "
                      "representativa. **(3) LA OBLIGACIÓN DEL ADR-036 §1 NO SE "
