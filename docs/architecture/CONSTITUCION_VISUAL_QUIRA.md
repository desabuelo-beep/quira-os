...
> que cada motor implementa la Constitución Ontológica. Arquitectura de render: `SISTEMA_VISUALIZACION_CANONICO.md`.
> **Los colores no son colores: son estados epistemológicos. Los íconos no decoran: representan evidencia.
> Los semáforos no son UX: son doctrina.**
...
- **PDF oficial** → Matplotlib (reproducible, control total).
- **Presentación** → export de alto contraste.
El renderer sigue ESTA Constitución, no los defaults de la librería. **Seaborn solo para ciencia**
