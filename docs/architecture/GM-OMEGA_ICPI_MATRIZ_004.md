...
|---|---|---|---|
| `P_i` | Coeficiente de Peso Presupuestario | **provenance provisionally verified** | referencia directa a H14!G |
| `R_i` | Coeficiente de Relevancia Normativa | **provenance provisionally verified** | fórmula + norma citada por meta |
| `V_i` | Inmutabilidad Documental | **TEMPORAL SEMANTIC GAP** | la columna leída se llama `Vi_2025` |
| `E_i` | Coeficiente de Fricción de Autonomía | **UNTRACEABLE · provenance gap** | literal sin fórmula ni fuente en el libro |
| `T_i` | Materialización Temporal | **provenance verified · sensitivity pending** | ratio por ENTIDAD ejecutora |
| `C_i` | Trazabilidad Orgánica | **provenance provisionally verified** | VLOOKUP a TBL_CALIBRACION_Ci |
...
| `E_i` | `H12!E29` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E15` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E16` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E11` | 0.750000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E8` | 0.900000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E9` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E10` | 0.900000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E13` | 0.750000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E24` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E25` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E19` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E28` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E30` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E18` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E20` | 0.900000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E21` | 0.900000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E14` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E22` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E23` | 0.750000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E26` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E27` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E6` | 1 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E17` | 0.750000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E12` | 0.750000 | `LITERAL (sin origen declarado)` | — |
...
| `E_i` | `H12!E7` | 1 | `LITERAL (sin origen declarado)` | — |
