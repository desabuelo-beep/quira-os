...
| REARQ | `Q-M1` | ¿Qué preguntas necesita responder QUIRA sobre la gestión pública? | ✅ | ★ las 4 familias YA estaban en el canon (macroejes) · 11 de 13 dominios SIN pregunta rectora · y aparece al CURAR, no al escribirla: el método es el PCD |
| REARQ | `Q-M2` | Cruce pregunta ↔ indicador · A responde · B parcial · C responde otra · D no existe | ⛔ | necesita las 11 preguntas que faltan · hoy sólo d01 y d09 son cruzables |
...
---
*QUIRA · Mapa Maestro · 25/47 etapas cerradas · 8 deudas abiertas · Dylus Lab © 2026*
