...
- **Corpus:** sin cambio en esta sesión (ver Pendientes).
...
- **Motores:** `enrich_rdc.py` (fidelidad H34b + CPCCS H31, campo muerto retirado) · `enrich_rdc_docx.py`
  (serie 3 años + cumplimiento desde los informes DOCX verificados).
...
- **Corpus de informes RDC:** los informes 2023-2025 **no están** en el corpus Supabase (el manifiesto solo
  tiene la *resolución* CPCCS, no los informes). Es una **expansión de canon transversal** (qué años, qué
  metadatos, `dominios=Dom09`), no un hueco específico de d09 — se decide con Javo antes de ingestar.
