...
🔑 **ADR-034 Capa B · DOM Planif v3: ②por-año✓ ①mapa✓** (`H11b` PDOT↔PND 25 metas/83%, gráfica · nace d01/consume d02). **d01 ~completo** (H11b+IPE+SAT-0+Ti). **Sig: pipeline DOM-001 (post-curación)→Orquestador. IFE/IED/IEF≠d01.**
🔶 **CI:** BOOT ≤6KB.
