...
🔑 **PCD** (7 capas). **d01+d09 base✓**. **d09→Compromisos+Aportes** (`METODOLOGIA_TRAZABILIDAD_APORTES.md` v0.2 · enricher✓→snapshot (55/37/4 atend/valid/sin) · pend UI+validación+cirugía+NLP). Sig **d08**.
🔶 **CI:** BOOT ≤6KB.
