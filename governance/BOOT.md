...
🔑 **Relacional ENCENDIDO en Planif✓** (`relacional.py` · cadena de integridad fuente-a-fuente). **Epistemología✓**: Gold Master=integración, NO verdad; verdad en fuentes (ADR-029). **Sig: Relacional en RDC (C-RDC) → Sentinel**.
🔶 **CI:** BOOT ≤6KB.
