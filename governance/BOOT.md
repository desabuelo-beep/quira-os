...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo = MOTOR transversal** (`PCD-MN01`·no dominio·no d04) · pipeline e2e✓ (video→98u→5 capas). **Fase CALIBRACIÓN**: Banco Casos+ICN+valid.FP/FN · NO exponer % · luego 2025.
🔶 **CI:** BOOT ≤6KB.
