...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo** (`PCD-MN01`·v0.1 LOCKED·5 capas·8 reglas·§21 rector). **ConstVis v1.7** (v10·pipeline·sin auditoría). **STT Whisper✓**. **RDC25✓**(45/22/2/13). **DOM RDC 24+25✓**→código.
🔶 **CI:** BOOT ≤6KB.
