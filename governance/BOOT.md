...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo** (`PCD-MN01`·§22 Relevancia Ontológica Capa0·§23 longitudinal). **ConstVis v1.7** (hallazgos·biografía dato). **RDC 24+25✓**→cajón `app/viz`→`m_rdc`→**deploy**.
🔶 **CI:** BOOT ≤6KB.
