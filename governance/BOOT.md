...
🔑 **Canon corregido✓ · Motor de Biografía inicial** (2025 fuente + continuidad inferida · NO longitudinal aún). **1A✓ · 1B ingesta~90% · 1C memoria ABIERTA.** **Sig: FASE 1.5 Consolidación** (longitudinal +PAC+contrato+devengado) → Neo4j.
🔶 **CI:** BOOT ≤6KB.
