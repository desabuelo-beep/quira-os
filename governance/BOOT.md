...
🔑 **DOM Planif✓ · RDC✓ óptimo** (cronológico+proveniencia+semáforo+tabla evidencia; cierre ya dictamina). Centro Intel. FOLIO (d01/d09 🔒). R1 Audit=falsa alarma. **Sig: d02 Presupuesto & Financiamiento (consume H11b · MAPA_ANCLAJE).**
🔶 **CI:** BOOT ≤6KB.
