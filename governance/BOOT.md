...
🔑 **PCD** (7 capas). **d01+d09 base✓**. **d09→Compromisos+Aportes** (`METODOLOGIA_TRAZABILIDAD_APORTES.md` v0.2 · cruce ventana✓ 70/15/11 a-tiempo/tarde/olvid · pend enricher+cirugía+UI+NLP). Sig **d08**.
🔶 **CI:** BOOT ≤6KB.
