...
🔑 **Canon SUBSANADO✓** (Ti 68→80→**73** · ICPI intacto). **Biografía de la meta✓** (unidad narrativa · 2026). **POA multi-año HALLADO** en `POA_GEOREFERENCIADO` (2023-26, crudo → inferir). **Sig: curar multi-año; luego Relacional RDC**.
🔶 **CI:** BOOT ≤6KB.
