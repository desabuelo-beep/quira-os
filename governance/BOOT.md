...
**Firewall (ADR-027 · 3 capas soberanía):** deuda **Familia QUIRA=119** (purgar) · canon Dylus/IA=35 (legítimo, NO purgar) · escáner `firewall_audit.py` etiqueta capas.
▶ **Firewall Blitz (solo Familia):** `p16_gobernanza` 13·`p_concejo` 11·`p14` 11·`m2_alertas` 11·`p12` 10·`p13` 9·`p11` 9 → deuda Familia a 0.
