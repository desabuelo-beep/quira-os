...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo** (`PCD-MN01`·v0.1 LOCKED·5 capas·8 reglas·§21 rector). **ConstVis v1.7** (v10·pipeline·sin auditoría). **STT Whisper✓** (transcribir_audio.py). RDC25 DRM→archivo. Congelar 2025.
🔶 **CI:** BOOT ≤6KB.
