...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo=MOTOR transversal** (`PCD-MN01`·v0.1 LOCKED·5c POA/PAC/R4/R6/CPCCS). **nivel_evidencia** 45ind/12inst/2parc/19sin·R8·fam. **§21 rector+cadena intersist.** IEP=dom.Transp. Pend CPCCS-B.
🔶 **CI:** BOOT ≤6KB.
