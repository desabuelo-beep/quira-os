...
🔑 **FASE 1 doc✓ · ADR-033 (2 verdades)** · **Proveniencia VISIBLE en cajón✓** (doc·analítico·interpret · `provenance.py`). **Sig paso 2: índices públicos al DOM (nombre público+método); paso 3: ambas dims→Neo4j `6c134c35`.**
🔶 **CI:** BOOT ≤6KB.
