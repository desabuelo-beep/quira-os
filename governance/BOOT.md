...
🩹 **12 GATES** · Curación por DOM (R.8) · **estados, NO bool** · 534 pruebas.
📑 ⛔ `.docx` gana al `.pdf`.
...
🧱 **ADR-053**: DOM = **agente gobernado** · d01+d02 migrados y atacados · **consulta d01↔d02 VIVA**: se comparte evidencia, NUNCA verdad.
