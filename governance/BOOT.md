...
🔑 **FASE 1 doc. CERRADA** (ADR-032 · VAL-001). **ADR-033: QUIRA=2 VERDADES** — documental (trazabilidad✓) + **ANALÍTICA** (índices del GM = OTRA MITAD · falta en DOMs). **Sig: índices al DOM (con proveniencia); FASE V→Neo4j `6c134c35`.**
🔶 **CI:** BOOT ≤6KB.
