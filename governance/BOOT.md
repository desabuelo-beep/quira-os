...
🔑 **PCD** (7 capas). **d01+d09 base✓**. **d09→Compromisos+Aportes** (`METODOLOGIA_TRAZABILIDAD_APORTES.md` v0.2 · POA2025-DOCX✓ · enricher+UI✓ 'Voz ciudadana' 46/31/19 · pend validación→cirugía GM · NLP). Sig **d08**.
🔶 **CI:** BOOT ≤6KB.
