...
🔑 **PCD**. **Motor Narrativo** `PCD-MN01` (§22 Relevancia Ontológica·§23 longitud.). **DOM RDC CERRADO✓** (cajón `app/viz`·`m_rdc` · Valor Demostrativo · LOTAIP · espera UEB). **Sig:** Planificación al patrón RDC **o** Gobernanza/IFE.
🔶 **CI:** BOOT ≤6KB.
