...
🔑 **Motor de Biografía (ADR-032) · biografía longitudinal✓**: Meta→POA→Partida→Plan→**CONTRATOS** (reconcil. PAC↔POA x descripción · 92% · salta muro de partida compartida). **Sig: reconciliar devengado igual; luego Neo4j+QUIRA IA.**
🔶 **CI:** BOOT ≤6KB.
