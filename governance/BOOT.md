...
🔑 **DOM Planif FINIQUITADO · Centro Inteligencia rework✓:** tarjetas mockup (barra+macro, sin pregunta), **solo d01/d09 entrables (resto 🔒)**, sin numeración (íconos). **Sig: completar DOM RDC (tablas evidencia + trazabilidad).**
🔶 **CI:** BOOT ≤6KB.
