...
**Firewall debt MEDIDO** (`scripts/dev/firewall_audit.py`): **190→154** · blitz (`p_cadena` 14→0) · `docs/architecture/FIREWALL_DEBT_REPORT.md`.
▶ **Firewall Blitz (sigue):** públicas `p16_gobernanza`·`p14`·`p12`·`p13`·`p11` → <100. Verificar gating antes (`is_tecnico`=GAD→purgar · `is_ops`=Dylus→OK).
