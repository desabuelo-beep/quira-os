...
🔑 **FASE 1 CERRADA** · Biografía longitudinal (ADR-032): Meta→POA→Partida→Plan→**CONTRATOS** (PAC↔POA 92%). Ejec real per-meta=dominio (no publicada). **FASE 2: Neo4j `6c134c35` ingiere `poa_multianio.json` (ADR-017/018) → QUIRA IA.**
🔶 **CI:** BOOT ≤6KB.
