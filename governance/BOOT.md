...
🏗️ **P5 (Javo)**: rearq = **construir vNEXT**, no auditar · hallazgo→**destino REARQ**, deuda sólo si falsea cifra (`DOC-027`) · 23 candidatos PROPUESTOS · 1 deuda (D-015) → **ratifica Javo** (`PANORAMA §5-octies`).
📑 ⛔ `.docx` gana al `.pdf`.
