...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo=MOTOR transversal** (`PCD-MN01`·v0.1 LOCKED). **Fase A✓** 98/98·7 reglas jurispr. **v0.2 36→70%**(proceso+eje)·**v0.3 capa PAC/SERCOP**(R7 ¿paja? 3/3·0FP·71%). Pend presup/CPCCS/ICN.
🔶 **CI:** BOOT ≤6KB.
