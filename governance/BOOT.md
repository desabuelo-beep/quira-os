...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo** transversal (`PCD-MN01`·v0.1 LOCKED·5 capas·8 reglas·§21 rector+cadena intersist·nivel_evidencia). **ConstVis v1.6** (v8·molde 8 pasos·ley c/art·base_norm). Congelar 2025·renderer.
🔶 **CI:** BOOT ≤6KB.
