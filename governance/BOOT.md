...
🩹 **12 GATES** · Curación por DOM (R.8) · **estados, NO bool** · 492 pruebas.
...
📡 **SITA 2025 0,4448** (era 0,4646: bueno lo no mirado) · **0 actas** · num.6 sin ingresos.
...
🔐 **PANEL ACCESOS** (→Ops): bitácora 2 meses sin leerse · alerta si fallos concentrados.
...
⛔ **EL NOMBRE NO ES EVIDENCIA** — 3× el GAD («acta»→certificado) · **1× nosotros**: 85 ensayos en `provenance/`.
