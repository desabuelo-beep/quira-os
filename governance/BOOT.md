...
🔑 **PCD** (7 capas). **d01+d09 base✓**. **d09→Compromisos+Aportes** (`METODOLOGIA_TRAZABILIDAD_APORTES.md` v0.2 · POA2025-DOCX✓ · enricher+UI+validación✓ 45at/51sin · marco legal en bloque · pend cirugía GM + NLP). Sig **d08**.
🔶 **CI:** BOOT ≤6KB.
