...
🔑 **PCD**. **d01+d09✓·Aportes 49/47**. **Motor Narrativo=MOTOR transversal** (`PCD-MN01`). **Fase A calibración**: Banco Casos✓ · 45/98 corregidos · 5 reglas jurisprudencia → roadmap motor v0.2 (3 mejoras). NO exponer % · sig lote 3.
🔶 **CI:** BOOT ≤6KB.
