...
🔑 **Motor de Biografía (ADR-032) · longitudinal✓**: Meta→POA→Partida→Plan→**CONTRATOS** (reconcil. PAC↔POA · 92%). Ejec real per-meta = dominio (SERCOP 2025 thin = hallazgo). **Sig: Fase 2 — Neo4j + QUIRA IA sobre objetos limpios.**
🔶 **CI:** BOOT ≤6KB.
