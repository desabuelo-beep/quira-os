...
| 19 | **No inducción documental** — *no se pide al GAD un dato que no produjo* | Javo · julio 2026 | `PROTOCOLO_CURACION_DOMINIO.md` **R-F** | acota la regla de la escalera de fuentes: solicitar vale si el documento YA existe (Caso A), nunca si nace de la pregunta (Caso B) | — *(regla de método)* | **activo** |
