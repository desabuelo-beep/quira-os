...
| 19 | **Régimen de solicitud documental** — *decide el estado de conocimiento del universo, no el acto de pedir* | Javo · julio 2026 | `PROTOCOLO_CURACION_DOMINIO.md` **R-F** | 3 casos: existe mal publicado → se pide · **conocido inexistente → NO** (induciría su creación) · **universo no conocido → se pide vía Observatorio**, y la respuesta ES evidencia | — *(regla de método)* | **activo** |
