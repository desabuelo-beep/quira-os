...
| 20 | **UDC** — Universo Documental Cerrado | asesoría · julio 2026 *(faltaba la condición objetiva de R-F)* | `PROTOCOLO_CURACION_DOMINIO.md` **R-F.1** | 3 condiciones: fuentes públicas agotadas · solicitudes vencidas · sin repositorios pendientes. **Se declara POR INSTRUMENTO, no por GAD** | estado UDC por instrumento | **activo** *(PP·POA·audiencias ✅ · GAD completo ❌)* |
