...
def build_g2_1_fuentes(ws) -> None:
    ...
    fuentes = [
        ...
        ("SIGAD",       "SIGAD SNP — Planificación",               "Web",          "sigad.senplades.gob.ec",              "Trimestral",    0.85, "D2"),
...
def build_g2_2_reliability(ws) -> None:
    ...
    datos = [
        ...
        ("SIGAD / SNP",              0.85, "Funcional", "Auto-reporte GAD — sujeto a subjetividad institucional",   "2026-05-18"),
