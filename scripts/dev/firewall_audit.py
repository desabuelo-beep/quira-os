...
PROHIBITED: list[tuple[re.Pattern, str]] = [
    ...
    (re.compile(r"\bICODS\b"),                      "Cumplimiento ODS"),
    (re.compile(r"\bIGM-[A-Z]\b"),                  "Equidad de genero"),
    (re.compile(r"\bRC-M\b"),                        "Trayectoria institucional"),
    (re.compile(r"\bTPS\b"),                        "Prioridad territorial"),
    (re.compile(r"\bAVEP\b"),                        "Escala de calificacion"),
