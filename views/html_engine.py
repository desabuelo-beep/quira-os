...
/* GRIDS — mobile: apilar columnas en pantallas < 600px */
@media (max-width: 600px) {
  .grid-2, .grid-3, .grid-4 {
    grid-template-columns: 1fr !important;
    gap: 10px;
  }
  /* Gauge SVG: reducir en móvil */
  svg[viewBox="0 0 220 130"] { width: 180px !important; height: 108px !important; }
  /* Texto grande: escalar abajo */
  .dp-value { font-size: 26px !important; }
  .page-title { font-size: 18px !important; }
  /* Cards: menos padding */
  .card { padding: 12px !important; }
  /* Tablas: scroll horizontal sin necesitar wrapper div */
  table.tbl {
    display: block;
    overflow-x: auto;
